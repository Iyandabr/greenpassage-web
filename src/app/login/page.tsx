...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#07111D" }}>
      {/* Left panel — branding */}
      <div className="hidden lg:flex flex-col justify-between w-[480px] shrink-0 p-12 relative overflow-hidden"
        style={{ background: "rgba(0,212,255,0.04)", borderRight: "1px solid rgba(0,212,255,0.08)" }}>
        {/* Background glow */}
        ...
        <div className="absolute bottom-0 right-0 w-64 h-64 rounded-full pointer-events-none"
          style={{ background: "radial-gradient(circle, rgba(0,212,255,0.05) 0%, transparent 70%)", transform: "translate(30%, 30%)" }} />
        ...
        <Link href="/" className="flex items-center gap-3 relative z-10">
          ...
          <span className="font-black text-lg text-white">Green<span style={{ color: "#00D4FF" }}>Passage</span></span>
        </Link>
        ...
        <div className="relative z-10">
          ...
          <p style={{ color: "rgba(255,255,255,0.45)", lineHeight: 1.7 }}>
            Join millions of people using AI to find their perfect pathway to Canada, UK, Germany, Australia, and beyond.
          </p>
        </div>
          ...
          <div className="flex -space-x-2">
            {["🇳🇬", "🇬🇭", "🇮🇳", "🇵🇭", "🇧🇷"].map((f, i) => (
              <div key={i} className="w-8 h-8 rounded-full flex items-center justify-center text-sm border-2"
                style={{ background: "#0C1A28", borderColor: "#07111D" }}>
                {f}
              </div>
            ))}
          </div>
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.45)" }}>
            <span className="text-white font-bold">2M+</span> migrants guided worldwide
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm mb-8" style={{ color: "rgba(255,255,255,0.4)" }}>Sign in to continue your journey</p>

          {/* Google */}
          <button className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-semibold mb-4 transition-all"
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs font-semibold block mb-1.5" style={{ color: "rgba(255,255,255,0.5)" }}>Email address</label>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs font-semibold" style={{ color: "#00D4FF" }}>Forgot?</Link>
              </div>
            ...
            <Link href="/dashboard">
              <button className="w-full py-3.5 rounded-xl font-bold text-sm mt-2 transition-all"
          ...
          <p className="text-center text-sm mt-6" style={{ color: "rgba(255,255,255,0.4)" }}>
            No account?{" "}
            <Link href="/signup" className="font-bold" style={{ color: "#00D4FF" }}>Create one free</Link>
          </p>
        </div>
      </div>
    </div>
